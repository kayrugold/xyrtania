...
export const AccountUI: React.FC = () => {
  ...
  return (
    <div className="absolute top-4 right-4 z-50 pointer-events-auto flex flex-col items-end gap-2">
      ...
      {isPanelOpen && (
        <div className="bg-black/90 text-white p-5 rounded shadow-2xl w-80 text-sm font-mono border border-emerald-900/50 backdrop-blur-md">
          ...
          {isRecovering ? (
            <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-gray-800">
              ...
              <textarea
                className="bg-gray-900 border border-gray-600 rounded p-2 text-white text-xs w-full h-20 outline-none resize-none focus:border-blue-500"
                value={phraseInput}
            ...
            <div className="flex flex-col gap-4">
              {!isSetupComplete ? (
                <div className="bg-gray-900 p-3 rounded border border-yellow-900/50">
                  <p className="text-xs text-yellow-500 mb-2 font-bold">1. Backup Your Passphrase</p>
                  <p className="text-[10px] text-gray-400 mb-2 leading-tight">This is the ONLY way to recover your account if you clear your browser data or switch devices.</p>
                ...
                <div className="bg-gray-900 p-3 rounded relative group cursor-pointer border border-gray-800">
              ...
              {!isSetupComplete && (
                <button 
                  ...
                  className="w-full bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed rounded py-2 text-sm font-bold text-white shadow-lg transition-colors mt-2"
                >
                  {isSyncing ? 'Syncing...' : 'Start Game'}
                </button>
              )}

              <div className="flex justify-between gap-2 mt-2 border-t border-gray-800 pt-3">
